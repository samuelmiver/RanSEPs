...
def run_ranseps(genome, cds, outDir, codon_table, min_size, species_code, eval_thr, threads):
    ...
    genome         = u.load_multifasta(genome)
    conservation   = sf.load_number_times_conserved(subcode, evalth=2e-8, alignth=0.0, lenth=0.0 , identh=50.0 , close=close_species, size=min_size)
